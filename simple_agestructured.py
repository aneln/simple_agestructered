...
#    params.set_param("sd_asymptomatic_to_recovery", 2)
    ...
    params.set_param("infectious_rate", 7)
    ...
    # proper smartphone usage
    params.set_param( "app_users_fraction", app_uptake_multiplier )
    params.set_param( "app_users_fraction_0_9",   app_uptake_multiplier * params.get_param( "app_users_fraction_0_9") )
    params.set_param( "app_users_fraction_10_19", app_uptake_multiplier * params.get_param( "app_users_fraction_10_19") )
    params.set_param( "app_users_fraction_20_29", app_uptake_multiplier * params.get_param( "app_users_fraction_20_29") )
    params.set_param( "app_users_fraction_30_39", app_uptake_multiplier * params.get_param( "app_users_fraction_30_39") )
    params.set_param( "app_users_fraction_40_49", app_uptake_multiplier * params.get_param( "app_users_fraction_40_49") )
    params.set_param( "app_users_fraction_50_59", app_uptake_multiplier * params.get_param( "app_users_fraction_50_59") )
    params.set_param( "app_users_fraction_60_69", app_uptake_multiplier * params.get_param( "app_users_fraction_60_69") )
    params.set_param( "app_users_fraction_70_79", app_uptake_multiplier * params.get_param( "app_users_fraction_70_79") )
    params.set_param( "app_users_fraction_80",    app_uptake_multiplier * params.get_param( "app_users_fraction_80") )   
